...
This repository contains the Source Code for the "Currency Converter" from 👻 [Cursor AI for Beginners: AI Coding Crash Course](https://linkly.link/2CKBT) course.
...
💬 [ChatGPT for Developers: AI Coding Crash Course](https://linkly.link/2GO88)\
👣 [OpenAI AgentKit: Build AI Agents & Automate Workflows](https://linkly.link/2GBbt)\
...
1. Open repository main [page](https://github.com/dvasyliev/cursor-currency-converter/).
...
1. Open [commits](https://github.com/dvasyliev/cursor-currency-converter/commits/main/) page.
...
Open the archive on your computer, open code editor and cick "File" -> "Open Folder" -> Choose project folder => "Open".
